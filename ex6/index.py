...
print("O valor bruto da viajem é de R$: {}. O valor do desconto sera de R$ {}. O valor liquido da viajem é de R$ {} e O valor médio por viajante sera de R$ {}".format(valor_bruto_viajem, valor_desconto, valor_liquido_viajem, valor_medio_viajante))