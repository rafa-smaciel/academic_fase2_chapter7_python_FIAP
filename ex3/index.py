...
if idade_usuario < 2:
    if batimentos_por_minuto >= 120:
        if batimentos_por_minuto <= 140:
            print("Usuário saudavel!")
        else:print("Batimentos acima do normal")
    else:print("Batimentos abaixo do normal")
elif idade_usuario > 8:
    if idade_usuario <= 17:
        if batimentos_por_minuto >= 80:
            if batimentos_por_minuto <=100:
                print("Usuario saudavel!")
            else:print("Batimentos acima do normal")
        else:print("Batimentos abaixo do normal")
    elif idade_usuario > 17:
        if idade_usuario <= 60:
            if batimentos_por_minuto >= 70:
                if batimentos_por_minuto <= 80:
                    print("Adulto saudavel!")
                else:print("Batimentos acima do normal")
            else:print("Batimentos abaixo do normal")
    elif idade_usuario > 60:
        if batimentos_por_minuto > 50:
            print("Idoso saudavel!")
            if batimentos_por_minuto <= 60:
                print("Idoso saudavel!")
            else:print("Batimentos acima do normal")
        else:print("Batimentos abaixo do normal")
